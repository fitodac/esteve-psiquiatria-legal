        ...
        tarteaucitron.addInternalScript(pathToLang, '', function () {
          ...
          if(tarteaucitronCustomText !== ''){
            ...
            tarteaucitron.addInternalScript(pathToServices, '', function () {
                ...
                html += '         <strong>Uso de cookies en el Sitio Web</strong><p>Este Sitio Web utiliza cookies propias y de terceros para finalidades analíticas, técnicas y de elaboración de perfile s; tratando los datos necesarios para la\n' +
                    'elaboración de perfiles basados en los hábitos de navegación del Usuario.</p><p><strong>¿Qué es una cookie?</strong><br>Este Sitio Web utiliza cookies y/o tecnologías similares que almacenan y recuperan información cuando navegas. En general, estas tecnologías pueden servir para finalidades muy diversas, como, por ejemplo, reconocerte como usuario, obtener información de tus hábitos de navegación, o personalizar la forma en que se muestra el contenido. Los usos concretos que hacemos de estas tecnologías se describen a continuación.</p><p><strong>¿Cómo puedo bloquear o eliminar las cookies que utiliza este Sitio Web?</strong><br>La primera vez que el Usuario visite el Sitio Web se le advertirá del uso de cookies y se le dará la posibilidad de aceptarlas todas o bien, acceder al panel de configuración que se incluye en esta Política de cookies. Exceptuando las cookies técnicas propias, que son necesarias para el funcionamiento del Sitio Web, el resto pueden ser rechazadas totalmente o de forma granular.<br>En posteriores visitas al Sitio Web, el Usuario podrá volver a configurar sus preferencias sobre el uso de cookies accediendo de nuevo a esta Política de cookies. Además de por medio del panel de configuración, el usuario también puede permitir, bloquear o eliminar las cookies instaladas en su equipo mediante la configuración de las opciones del navegador instalado en su ordenador. Si acepta las cookies de terceros, también podrá eliminarlas desde el sistema ofrecido por el propio tercero.<br>El hecho de bloquear la instalación de las cookies no impide la efectiva utilización del Sitio Web por parte del Usuario.<br>Puede informarse de las transferencias a terceros países que, en su caso, realizan los terceros identificados en el cuadro anterior en sus correspondientes políticas (ver enlaces facilitados en la columna "Más información").</p>';
                if (tarteaucitron.parameters.privacyUrl !== "") {
                    html += '   <br/><br/>';
                    html += '   <button type="button" id="tarteaucitronPrivacyUrlDialog" role="link" formtarget="_blank">';
